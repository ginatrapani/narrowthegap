          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <p>
                ...
                , on average women are still paid less than their male
                counterparts for doing comparable jobs in the U.S. &mdash;
                that&#8217;s called the pay gap. It means that each time the
                average woman starts a new job, she&#8217;s likely to start from
                a lower base salary than her male counterparts.
              </p>
              <p>
                Just as interest compounds, so does the pay gap. As a woman
                moves from job to job during her career, the pay gap between her
              ...
              <h2>{2058 - new Date().getFullYear()} more years</h2>
              <p>
              ...
              <p>
                Women make up nearly half of the labor force and mothers are the
                primary or co-breadwinners in the majority of families. When
                women aren&#8217;t paid fairly, families suffer and the American
                economy suffers.
              </p>
            </div>
            <div className="col-md-4">
              ...
              <p>
                Insist on equal pay for equal work in your and your loved
                ones&#8217; workplaces. Here&#8217;s what you can do.
              </p>
              <ul>
                <li>
                ...
                <li>
                  <strong>Raise awareness</strong> about the pay gap. To start,
                  tweet, like, share, and blog a page from this site.
                </li>
                <li>
                  <strong>Talk to employees and employers</strong> you know
                  about the pay gap, salary negotiation techniques, and equal
                  pay laws.
                </li>
                <li>
            ...
            <div className="col-md-4">
              ...
              <blockquote>
                <p>
                  &quot;Women work fewer hours than men so it follows they earn
                  less.&quot;
                </p>
                <footer>
                  The data set presented here only counts the salaries of
                  full-time workers.
                </footer>
              </blockquote>
              ...
              <blockquote>
                <p>
                  &quot;Women choose lower-paying jobs so that&#8217;s why
                  there&#8217;s a pay gap.&quot;
                </p>
                <footer>
              ...
              <blockquote>
                <p>
                  &quot;Women don&#8217;t negotiate their salary as aggressively
                  as men so it&#8217;s their fault there&#8217;s a pay
                  gap.&quot;
                </p>
                <footer>
                  Better negotiation techniques can help close the wage gap, but
                  the problem is multi-faceted and systemic.
                </footer>
              </blockquote>

              <blockquote>
                <p>
                  &quot;Women choose to stay home with their kids so they have
                  less professional experience than men and thus should earn
                  less.&quot;
                </p>
                <footer>
              ...
              <blockquote>
                <p>
                  &quot;In a lot of jobs, there&#8217;s no pay gap&mdash;and
                  sometimes, women earn more than men.&quot;
                </p>
                <footer>
                  Pay disparity does not exist in every occupation, but across
                  all occupations, women consistently earn less at the same
                  jobs.
                </footer>
              </blockquote>
            </div>
