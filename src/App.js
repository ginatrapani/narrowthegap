            ...
            <div className="App">
                <div className="container">
                    ...
                    <div className="jumbotron">
                        <h1>
                            Women <span style={inTheUSStyle}>
                                in the U.S.
                            </span>{" "}
                            make <span style={centsStyle}>
                                81&nbsp;cents
                            </span>{" "}
                        ...
                        <p>
                            ...
                            <strong style={yearlyGapStyle}>$8,788</strong> less
                            per year.
                        </p>
                        <a
                            href="https://twitter.com/share"
                            className="twitter-share-button"
                            data-url="http://narrowthegapp.com/"
                            data-lang="en"
                            data-text="Women in the U.S. make 81 cents to the dollar men earn #NarrowTheGap"
                        >
                            Tweet
                        </a>
                        <span
                            className="fb-share-button"
                            data-href="http://narrowthegapp.com/"
                            data-layout="button"
                        />
                        <br />
                        <h6>
                            Wage gap calculated from 2015 median weekly earnings
                            of full-time salary workers in the United States as
                            per the{" "}
